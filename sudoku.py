...
def sudoku():
    ...
    pygame.display.set_caption("SUDOKU BY BINGO AMIGOS") 
    img = pygame.image.load('C:\\Users\\ABHIJITHSBABU\\brain steaks\\sudoku.png') 
    ...
    def bg():
        ...
        bg1 = pygame.image.load('C:\\Users\\ABHIJITHSBABU\\brain steaks\\sudoku.png')
    ...
    def draw_box(): 
    	for i in range(2): 
    		pygame.draw.line(mydis, (255, 255, 255), (x * dif-2+230, (y + i)*dif+110), (x * dif + dif + 2+230, (y + i)*dif+110), 7) 
    		pygame.draw.line(mydis, (255, 255, 255), ( (x + i)* dif+230, y * dif+110 ), ((x + i) * dif+230, y * dif + dif+110), 7) 
